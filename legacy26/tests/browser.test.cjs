...
before(async()=>{
  server=http.createServer((req,res)=>{
    ...
    if(!['index.html','editions.js','targeted-fixes.js','visual-policy.js','visual-runtime.js','google-direct.js','background-runtime.js','identity-names.js','slab-identity.js','identity-final.js','image-evidence.js','catalogue-engine.js','catalogue-sources.js','catalogue-runtime.js','lens-policy.js','lens-runtime.js'].includes(name)){res.writeHead(404);res.end();return;}
