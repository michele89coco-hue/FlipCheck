...
test('catalogue printing completion closes the production identity without another Vision and retains observed holo',async()=>{
 ...
 vm.createContext(env);vm.runInContext(runtime.slice(runtime.indexOf('function rememberEvidence189('),runtime.indexOf('function newContext164(')),env);vm.runInContext(runtime.slice(runtime.indexOf('async function finishIdentity171('),runtime.indexOf('resolveIdentificationCheap=async function')),env);
