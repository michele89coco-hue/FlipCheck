    ...
    private ScanSession(Context context) {
        ...
        web.setWebViewClient(new WebViewClient() {
            @Override public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                ...
                if (!path.matches("/(index\\.html|editions\\.js|targeted-fixes\\.js|visual-policy\\.js|visual-runtime\\.js|google-direct\\.js|background-runtime\\.js|identity-names\\.js|slab-identity\\.js|identity-final\\.js|image-evidence\\.js|price-summary\\.js|card-market\\.js|card-market-runtime\\.js|ximilar-policy\\.js|ximilar-runtime\\.js|market-identity\\.js|catalogue-engine\\.js|catalogue-sources\\.js|catalogue-runtime\\.js|lens-policy\\.js|lens-runtime\\.js)"))
                    return missing();
