...
async function compareLensImages206(l,ctx){
 ...
 while(pending.size){
  ...
  if(report.entries.length&&E193.reduce(l,report.entries).market_ready){report.stopReason='verified_identity';break;}
 }
