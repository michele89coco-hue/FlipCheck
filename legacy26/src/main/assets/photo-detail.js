...
Mantieni le deduzioni (nome commerciale, set ricavato da simbolo/design) nei campi family/model, mai nei testi letterali. In layout_signature indica la posizione SOLO di parole realmente stampate. Per ogni quantità leggi l'intera frase, l'unità, le note e il denominatore: non unire righe distinte. Se non sei sicuro di una quantità decisiva, segnala l'incertezza in missing_information e indica il ritaglio preciso. Non dedurre il formato di un prodotto da un'immagine promozionale di un contenuto possibile.
