...
function evaluate(l,entry){
 ...
 if(['onepiece','tcg','sports'].includes(l.domain)&&printingLang&&k.language&&!printingLanguageCompatible201(printingLang,k.language))reasons.push('different_printing_language');
