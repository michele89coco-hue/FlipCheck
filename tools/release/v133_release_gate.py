#!/usr/bin/env python3
"""Fail closed unless the exact v1.33 APK has complete installed live evidence."""
...
def main() -> int:
    ...
    checks = {
        ...
        "versionCode": int(live.get("versionCode", 0)) == 137,
        "versionName": live.get("versionName") == "1.33-live-validated-global-resolver",
