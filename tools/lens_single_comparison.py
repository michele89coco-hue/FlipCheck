#!/usr/bin/env python3
"""Run the one user-supplied original image through one Lens provider."""
import hashlib
import importlib
import json
import os
...
FIXTURE_PATH = "tools/regression/fixtures/lens-single-20260909"
CASES = [("image_a", "image-a.jpg")]
EXPECTED = {
    "image-a.jpg": "e17c7a35e051c134298c33b1a3b750f7b68981617b2418c04f6fc503abe5fdb0"
}
...
def main():
    ...
    probe.output = output
    destination = ROOT / "single-lens-results" / provider
    destination.mkdir(parents=True, exist_ok=True)
    os.chdir(destination)
    output("SINGLE_INPUTS", {
    ...
    def review(path):
        ...
        for case in report.get("cases", []):
            ...
            output("SINGLE_REVIEW", {"provider": provider, **selected})
    review(report_path)
