...
final class CatalogConsistencyV3 {
    ...
    static Result check(IdentityCandidateV2 c,DomainProfileRouterV2.Profile profile){
        ...
        if(c.exactReference&&(empty(c.sourceRecordId)||!("SINGLE_RECORD".equals(c.sourcePageScope)||"CHECKLIST_ROW".equals(c.sourcePageScope))))return new Result(false,"exact_reference_without_isolated_record");
